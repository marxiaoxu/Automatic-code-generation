...
typedef struct {
  ...
  uint32_T CAN_Read_Data1_o3;          /* '<S4>/CAN_Read_Data1' */
  uint32_T DiscreteTimeIntegrator1;    /* '<S1>/Discrete-Time Integrator1' */
  uint16_T CAN_NbPendingMsg;           /* '<Root>/CAN_NbPendingMsg' */
  uint16_T USART_Send2;                /* '<S2>/USART_Send2' */
  uint16_T CAN_Read_Data1_o5;          /* '<S4>/CAN_Read_Data1' */
  uint8_T TmpRTBAtSubsystem2Outport1;  /* '<Root>/Subsystem2' */
  uint8_T Timers1_o1;                  /* '<S2>/Timers1' */
  uint8_T DataStoreRead3;              /* '<S1>/Data Store Read3' */
  uint8_T DataTypeConversion;          /* '<S1>/Data Type Conversion' */
  uint8_T DataTypeConversion1;         /* '<S1>/Data Type Conversion1' */
  uint8_T CAN_Read_Data1_o1;           /* '<S4>/CAN_Read_Data1' */
  uint8_T CAN_Read_Data1_o2;           /* '<S4>/CAN_Read_Data1' */
  uint8_T CAN_Read_Data1_o4;           /* '<S4>/CAN_Read_Data1' */
  uint8_T CAN_Read_Data1_o6[8];        /* '<S4>/CAN_Read_Data1' */
  boolean_T GPIO_Read;                 /* '<Root>/GPIO_Read' */
} B_xusiming;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  uint32_T DiscreteTimeIntegrator1_DSTATE;/* '<S1>/Discrete-Time Integrator1' */
  uint32_T Subsystem1_PREV_T;          /* '<Root>/Subsystem1' */
  uint32_T DiscreteTimeIntegrator1_PREV_U;/* '<S1>/Discrete-Time Integrator1' */
  uint8_T Delay1_DSTATE;               /* '<S1>/Delay1' */
  uint8_T DiscreteTimeIntegrator_DSTATE;/* '<S1>/Discrete-Time Integrator' */
  uint8_T execpt;                      /* '<Root>/Data Store Memory' */
  uint8_T kp;                          /* '<Root>/Data Store Memory1' */
  uint8_T ki;                          /* '<Root>/Data Store Memory2' */
  uint8_T DiscreteTimeIntegrator1_SYSTEM_ENABLE;/* '<S1>/Discrete-Time Integrator1' */
  uint8_T DiscreteTimeIntegrator_PREV_U;/* '<S1>/Discrete-Time Integrator' */
 ...
 * '<S8>'   : 'xusiming/Subsystem5/If Action Subsystem2'
 */
